...
class blackwhite(object):
    ...
    def AI_evaluate_list(self,queue):
        ...
        for each in queue:
            ...
            egb = each[1]
            estep = each[2][0]
            if estep in [(0,0),(0,n0-1),(n0-1,0),(n0-1,n0-1)]:
                bestmove = estep
                break
            elif estep in [(0,1),(1,0),(1,1),(0,n0-2),(1,n0-2),(1,n0-1),(n0-2,0),(n0-2,1),(n0-1,1),(n0-2,n0-2),(n0-2,n0-1),(n0-1,n0-2)]:
                continue
